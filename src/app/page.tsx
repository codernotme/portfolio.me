...
<Link href="#" target="_blank" className="button first"><button>View Source</button><span></span></Link>

<Link href="#" target="_blank" className="button sec"><button>Watch Video</button><span></span></Link>

<Link href="#" target="_blank" className="button third"><button>Connect</button><span></span></Link>
